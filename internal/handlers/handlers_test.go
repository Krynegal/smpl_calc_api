...
//			ts := httptest.NewServer(http.HandlerFunc(HandlerAdd))
...
//	for _, tt := range tests {
//		t.Run(tt.name, func(t *testing.T) {
//			ts := httptest.NewServer(http.HandlerFunc(HandlerSub))
...
//	for _, tt := range tests {
//		t.Run(tt.name, func(t *testing.T) {
//			ts := httptest.NewServer(http.HandlerFunc(HandlerMul))
//			target := fmt.Sprintf("/api/mul?a=%s&b=%s", tt.operand1, tt.operand2)
//			resp, body := testRequest(t, ts, http.MethodGet, target)
//
//			defer resp.Body.Close()
//			assert.Equal(t, http.StatusOK, resp.StatusCode)
//			assert.Equal(t, tt.success, body)
//			assert.Equal(t, tt.wantRes, body.Value)
//		})
//	}
//}
...
//	for _, tt := range tests {
//		t.Run(tt.name, func(t *testing.T) {
//			ts := httptest.NewServer(http.HandlerFunc(HandlerDiv))
